                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo site_url($this->PANEL . '/' . $this->CONTROLLER . '/' . $this->EDIT_CONTROLLER_NAME . '/' . $id) ?>" name="myform"  method="post" enctype="multipart/form-data" onsubmit="if(mobilevalidate()<?php if ($id) {echo '&& confirmation()';} ?> ){return true;}else{return false;}">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" required="required" for="first-name">Security Question<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text"  name="form[sq_question]" value="<?php echo $sq_question ?>"  class="form-control col-md-7 col-xs-12">
                                    <br/><br/>
                                </div>
                                <font color="#FF0000"><?php echo form_error('form[sq_question]');?></font>
                            </div>
