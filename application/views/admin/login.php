...
<html lang="en">
    ...
    <head>
        ...
        <title>EezyBee || Admin Panel</title>
                    ...
                    <section class="login_content">
                        <form  action="" method="post" > 
                            ...
                            <div>
                                ...
                                <a class="reset_pass" href="<?php echo site_url('admin/admin/forgotPassword') ?>">Lost your password?</a>
                            </div>
                            ...
                            <div class="separator">
                                ...
                                <div>
                                    ...
                                    <p>©2017 All Rights Reserved. EezyBee!  </p>
                                </div>
                            </div>
                        </form>
                        <!-- form -->
